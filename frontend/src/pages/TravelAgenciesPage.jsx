        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 w-full">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <Link to="/How-to-get-there.html" className="text-primary-foreground/60 text-sm font-body hover:text-primary-foreground transition-colors">Getting There</Link>
              <ChevronRight className="w-3.5 h-3.5 text-primary-foreground/40" />
        ...
        <Tabs defaultValue={city} className="w-full">
          <TabsList className="grid grid-cols-3 w-full max-w-lg mb-10 bg-muted">
            <TabsTrigger value="chania" asChild>
              <Link to="/Travel-Agencies-Chania.html" className="font-body text-sm">From Chania</Link>
            </TabsTrigger>
            <TabsTrigger value="rethymnon" asChild>
              <Link to="/Travel-Agencies-Rethymnon.html" className="font-body text-sm">From Rethymnon</Link>
            </TabsTrigger>
            <TabsTrigger value="heraklion" asChild>
              <Link to="/Travel-Agencies-Heraklion.html" className="font-body text-sm">From Heraklion</Link>
            </TabsTrigger>
          </TabsList>
        ...
        <Card className="mt-10 bg-muted border-border shadow-card">
          <CardContent className="p-5">
            <p className="text-sm text-muted-foreground font-body leading-relaxed">
              ...
              <Link to="/How-to-get-there.html" className="text-primary font-medium hover:underline">
                How to Get There
              </Link>

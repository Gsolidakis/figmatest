                  ...
                  <div className="space-y-5">
                    <Card className="bg-card border-border shadow-card">
                      <CardContent className="p-6">
                        ...
                        <div className="space-y-4">
                          <TimetableRow from="Chania" href="Xyloskalo" time="06:15 → 07:45" note="Every day" />
                          <TimetableRow from="Sougia" href="Xyloskalo" time="07:00" note="Every day" />
                          <TimetableRow from="Paleochora" href="Xyloskalo" time="06:30" note="Mon, Wed, Fri" />
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="bg-card border-border shadow-card">
                      <CardContent className="p-6">
                        ...
                        <div className="space-y-4">
                          <TimetableRow from="Sougia" href="Chania" time="18:15" note="After ferry arrival" />
                          <TimetableRow from="Chora Sfakion" href="Chania" time="18:30" note="After ferry arrival" />
                        </div>
                      </CardContent>
                    </Card>
                  </div>
